...
# convert categorical to binary and ordinal features
def binary(YN):
    if (YN == 'Y'):
        return 1
    else:
...
# convert CSV raw file to LabelPoint, all data must be numerical
...
# Now get predictions for our unknown candidates
